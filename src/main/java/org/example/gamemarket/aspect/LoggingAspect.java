package org.example.gamemarket.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * org.example.gamemarket.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * org.example.gamemarket.service.*.*(..))")
