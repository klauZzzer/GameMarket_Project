...
@Operation(
        ...
        description = "Delete an existing developer by ID",
        tags = {"DEVELOPER"},
        parameters = {
                @Parameter(
                        name = "id",
                        description = "The unique developer ID",
                        required = true,
                        in = ParameterIn.PATH,
        ...
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "The developer was successfully removed"
                ),
                @ApiResponse(
                        responseCode = "510",
                        description = "This developer not exist in base"
                )
        }
)
public @interface DeleteDeveloperById {
